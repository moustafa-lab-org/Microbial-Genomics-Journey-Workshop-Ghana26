...
* To follow the steps here, you need to download this file using `wget -O problem_set6.tar.gz https://www.dropbox.com/s/hyjuujea5y0wd2c/problem_set6.zip?dl=0 --no-check-certificate`
* Make sure the file is inside MGJW `mv problem_set6.tar.gz /data/MGJW`.
* `mkdir problem_set6`
